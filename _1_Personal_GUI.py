...
class InfoWindow(QtWidgets.QFrame):
    ...
    def ui(self):
        ...
        basic_info_parent_widget.setFixedHeight(200) # 調整基本資料背景區塊(layer 1)的大小
        ...
        basic_info_input_widget_layout = QtWidgets.QGridLayout(basic_info_input_widget) # 基本資料填寫區塊(layer 2)的排版
